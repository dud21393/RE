...
{
?>
<form action="../Ctl/MainCTL.php?action=612" method="post" enctype="multipart/form-data">
    <?php
    }else{
    echo $bnum;
    ?>
    <form action="../Ctl/MainCTL.php?action=621&bnum=<?=$bnum?>" method="post" enctype="multipart/form-data">
        <?php
        }
        ?>
    <table  width="900px">
