...
$board_serch['all']=isset($_REQUEST['all'])?$_REQUEST['all']:null;
    ...
    <table border="1" width="800px" align="center">
            ...
            for ($iCount = 0; $iCount < count($boardList); $iCount++) {
                ...
                echo "<td><a href='../Ctl/MainCTL.php?action=618&bnum={$boardList[$iCount][0]}&hit=true&page={$boardpageInfo['current_page']}'>"
                    . $boardList[$iCount][2] ."</a></td>"; //제목
...
if($id) {
    ...
    echo "<a href='../Ctl/MainCTL.php?action=611'>글쓰기</a>";
    echo "</form>";
}
if($boardList)
{
